...
def main():
    ...
    q1=streamWriter(input=vehicleDF,
                checkpointFolder='s3a://spark-streaming-data-for-smart-city-de/checkpoints/vehicle_data',
                output='s3a://spark-streaming-data-for-smart-city-de/data/vehicle_data')
    q2=streamWriter(input=gpsDF,
                checkpointFolder='s3a://spark-streaming-data-for-smart-city-de/checkpoints/gps_data',
                output='s3a://spark-streaming-data-for-smart-city-de/data/gps_data')
    q3=streamWriter(input=trafficDF,
                checkpointFolder='s3a://spark-streaming-data-for-smart-city-de/checkpoints/traffic_data',
                output='s3a://spark-streaming-data-for-smart-city-de/data/traffic_data')
    q4=streamWriter(input=weatherDF,
                checkpointFolder='s3a://spark-streaming-data-for-smart-city-de/checkpoints/weather_data',
                output='s3a://spark-streaming-data-for-smart-city-de/data/weather_data')
    q5=streamWriter(input=emergencyDF,
                checkpointFolder='s3a://spark-streaming-data-for-smart-city-de/checkpoints/emergency_data',
                output='s3a://spark-streaming-data-for-smart-city-de/data/emergency_data')
    q5.awaitTermination()
